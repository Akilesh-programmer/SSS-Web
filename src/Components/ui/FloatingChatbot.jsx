        ...
        {isChatOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-3xl w-full max-w-2xl h-[600px] max-h-[90vh] flex flex-col overflow-hidden shadow-2xl border border-purple-200"
            ...
            >
              ...
              <div className="flex flex-col flex-1 min-h-0">
                {/* Messages Area */}
                <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gradient-to-b from-purple-50/50 to-white min-h-0">
                ...
                {/* Input Area - Enhanced */}
                <div className="p-4 border-t border-purple-100 bg-gradient-to-r from-white to-purple-50/30 flex-shrink-0">
                  <div className="flex gap-3 items-end">
                    <div className="flex-1">
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="Type your question about services, appointments, doctors..."
                          className="w-full p-3 pr-10 border-2 border-purple-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none text-sm bg-white/80 backdrop-blur-sm transition-all duration-300 hover:border-purple-300"
                        />
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-violet-500 to-purple-600 text-white p-3 rounded-xl hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center min-w-[48px]"
              ...
              <div className="absolute inset-0 pointer-events-none overflow-hidden">
                {[
                  ...
                  <motion.div
                    ...
                    className="absolute text-4xl text-purple-300/60"
                    style={{
                      left: `${item.x}%`,
                      top: `${item.y}%`,
                    }}
