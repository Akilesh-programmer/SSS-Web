                ...
                {floatingButtons
                  ...
                  .map((button, index) => (
                    <motion.button
                      ...
                      className={`group relative bg-gradient-to-r ${button.color} text-white w-14 h-14 flex items-center justify-center rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110`}
                    >
