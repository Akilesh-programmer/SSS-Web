...
export const PAGE_SEO = {
  ...
  doctors: {
    ...
    description:
      "Meet our team of 25+ highly qualified specialist doctors across 20+ medical specialities at SSS Hospital Erode. Experienced physicians dedicated to your wellbeing. Book a consultation today.",
    keywords: [
      "doctors in erode",
      "specialist doctors erode",
      "best doctors erode",
...
// Complete department-specific SEO templates for all departments
...
// Doctor profile SEO generator — optimized for local search
